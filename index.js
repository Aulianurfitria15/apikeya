...
const db = mysql.createConnection({
    host: 'localhost',
    user: 'root',
    password: 'Telagasari15', // Pastikan password ini benar
    database: 'apikey',
    port: 3307 // Pastikan port ini benar
});
...
app.post("/generate-api-key", (req, res) => {
    ...
    const sql = "INSERT INTO apikey_aulia (apikey_a) VALUES (?)"; 
...
app.post("/check", (req, res) => {
    ...
    const sql = "SELECT * FROM apikey_aulia WHERE apikey_a = ?"; 
